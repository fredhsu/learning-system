...
mod efficiency_tests {
    ...
    use crate::models::{BatchGradingRequest, CreateCardRequest, QuizQuestion};
    use uuid::Uuid;
    ...
    async fn test_batch_grading_structure() {
        ...
        let requests = vec![BatchGradingRequest {
    ...
    async fn test_content_length_bucketing() {
        use crate::card_service::{
            calculate_overdue_ratio, get_content_length_bucket, get_difficulty_bucket,
        };
        use chrono::Utc;
